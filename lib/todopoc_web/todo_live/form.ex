defmodule TodopocWeb.TodoLive.Form do
  ...
  def mount(params, _session, socket) do
    todo =
      case params["id"] do
        nil -> nil
        id -> Ash.get!(Todopoc.Todos.Todo, id)
      end
  ...
  defp assign_form(%{assigns: %{todo: todo}} = socket) do
    form =
      if todo do
        AshPhoenix.Form.for_update(todo, :update, as: "todo")
      else
        AshPhoenix.Form.for_create(Todopoc.Todos.Todo, :create, as: "todo")
      end
